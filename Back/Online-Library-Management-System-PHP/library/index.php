...
<div class="col-md-12">
<h4 class="header-line">FORMULARIO DE INICIO DE SESIÓN DE USUARIO</h4>
</div>
</div>
 <a name="ulogin"></a>            
<!--LOGIN PANEL START-->           
...
<p class="help-block"><a href="user-forgot-password.php">Has olvidado tu contraseña</a></p>
 ...
 <button type="submit" name="login" class="btn btn-info">LOGIN </button> | <a href="signup.php">Aún no estás registrado</a>
</form>
 </div>
</div>
</div>
