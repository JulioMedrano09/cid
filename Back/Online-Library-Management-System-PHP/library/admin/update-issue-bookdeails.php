...
<head>
    ...
    <title>Sistema de gestión de bibliotecas en línea | Detalles de libros publicados</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Detalles del libro publicado</h4>
...
<div class="col-md-6"> 
<div class="form-group">
<label>ID E-mail del estudiante :</label>
<?php echo htmlentities($result->EmailId);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Número de contacto del estudiante :</label>
