...
<head>
    ...
    <title>Sistema de gestión de bibliotecas en línea | Editar libro</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Agregar libro</h4>
...
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Cambiar la imagen del libro</a>
</div></div>
...
<p class="help-block">Un ISBN es un Número Internacional Estándar de Libro. El ISBN debe ser único.</p>
</div></div>


<div class="col-md-6">
 <div class="form-group">
 <label>Precio en USD<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="price" value="<?php echo htmlentities($result->BookPrice);?>"   required="required" />
 </div></div>
 <?php }} ?><div class="col-md-12">
<button type="submit" name="update" class="btn btn-info">Actualizar </button></div>
