...
<head>
    ...
    <title>Sistema de gestión de bibliotecas en línea | Historial de estudiantes</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <?php $sid=$_GET['stdid']; ?>
                <h4 class="header-line">#<?php echo $sid;?> Historial de emisión de libros</h4>
    </div>
